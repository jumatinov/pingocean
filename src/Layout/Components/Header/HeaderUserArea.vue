                        ...
                        <b-dropdown toggle-class="p-0 mr-2" menu-class="dropdown-menu-lg" variant="link" no-caret right>
                            <span slot="button-content">
                                <div class="icon-wrapper icon-wrapper-alt rounded-circle">
                                    <img width="42" v-if="user.avatar" class="rounded-circle" :src="user.avatar" alt="">
                                    <img width="42" v-else class="rounded-circle" src="/images/default_avatar.jpg" alt="">
                                </div>
                            </span>
...
<!--                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Users-->
...
<!--                                            <div class="ml-auto badge badge-success">New</div>-->
                                        ...
                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Finance
<!--                                            <div class="ml-auto badge badge-warning">512</div>-->
                                        </a></li>
                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Tickets</a></li>
                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Account Settings</a></li>
                                    </ul>
                                </VuePerfectScrollbar>
                            </div>
                        </b-dropdown>
                    ...
                    <div class="widget-content-left  ml-3 header-user-info">
                        <div class="widget-heading">{{ user.name }}</div>
                        <div class="widget-subheading">{{ user.company_name }}</div>
                    </div>
                </div>
            </div>
        </div>
